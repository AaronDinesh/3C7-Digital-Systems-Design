...
HD_PWD='C:/Users/aaron/Desktop/Lab1/project_1/project_1.runs/sine_high_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_high.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sine_high.tcl
